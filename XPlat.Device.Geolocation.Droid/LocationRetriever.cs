    ...
    internal class LocationRetriever : Java.Lang.Object, ILocationListener
    {
        ...
        public void OnProviderDisabled(string provider)
        {
            lock (this.activeLocationProviders)
            {
                ...
                {
                    this.tcs.TrySetException(new GeolocatorException("A location cannot be retrieved as the provider is unavailable."));
                }
            }
        }
        ...
        {
            this.completedAction?.Invoke();
            this.tcs.TrySetResult(location?.ToLocalGeoposition());
        }
    }
}